...
?>
<main class="phinit-plugin m365mc-archive" id="m365-messagecenter">
    <header class="m365mc-hero" aria-labelledby="m365mc-title">
    ...
    <section class="m365mc-results" aria-labelledby="m365mc-results-title">
        <div class="m365mc-results__head">
            <div>
                <p class="m365mc-kicker">Live aus lokalem Cache</p>
                <h2 id="m365mc-results-title">Meldungen</h2>
            </div>
        ...
        <div class="m365mc-list" role="list">
            ...
            $detailUrl = $graphId !== '' ? $baseUrl . '/' . rawurlencode($graphId) : $baseUrl;
            $excerpt = $excerptWords((string) ($item['body_excerpt'] ?? ''), 200);
            ?>
            <article class="m365mc-card m365mc-card--linked phinit-card" role="listitem">
                <header class="m365mc-card__header">
                    <div>
                        ...
                        <h3><a href="<?php echo $esc($detailUrl); ?>"><?php echo $esc($title); ?></a></h3>
                    </div>
                ...
                <?php endif; ?>
                <?php if ($showExternalLinks && $externalUrl !== ''): ?>
                <footer class="m365mc-card__footer">
                    <a href="<?php echo $esc($detailUrl); ?>" class="phinit-btn phinit-btn--secondary">Details öffnen</a>
                    <a href="<?php echo $esc($externalUrl); ?>" class="phinit-btn phinit-btn--link" target="_blank" rel="noopener noreferrer">Microsoft-Link öffnen <span aria-hidden="true">→</span></a>
                </footer>
                <?php else: ?>
                <footer class="m365mc-card__footer">
                    <a href="<?php echo $esc($detailUrl); ?>" class="phinit-btn phinit-btn--secondary">Details öffnen</a>
