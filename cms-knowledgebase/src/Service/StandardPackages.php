...
Get-Mailbox user@contoso.com | Select *quota*</code></pre><p>Damit passt der Eintrag bewusst zu einem operativen KB-Artikel: kurz erklären, Voraussetzungen nennen, Änderung dokumentieren und das Ergebnis direkt verifizieren.</p>',
    ...
    private function definitionFor(string $title, string $area): string
    {
        ...
        return match ($key) {
            ...
            'bedingter zugriff' => 'ist die deutschsprachige Bezeichnung für Conditional Access und steuert Zugriffe anhand definierter Risiko-, Geräte- und Standortbedingungen.',
            ...
            'microsoft stream' => 'ist die Video-Plattform in Microsoft 365 für Upload, Verwaltung, Bereitstellung und Einbindung von Unternehmensvideos.',
            'microsoft stream classic' => 'bezeichnet die frühere Version von Microsoft Stream, die schrittweise durch SharePoint-basierte Videofunktionen ersetzt wurde.',
            'microsoft whiteboard' => 'ist eine digitale Kollaborationsfläche für Skizzen, Brainstorming und visuelle Zusammenarbeit in Teams und Meetings.',
            'microsoft whiteboard online' => 'ist die cloudbasierte Nutzung von Microsoft Whiteboard über Browser und Microsoft-365-Dienste.',
            'microsoft sway' => 'ist ein webbasiertes Präsentations- und Storytelling-Tool für interaktive Berichte, Newsletter und visuelle Inhalte.',
            'microsoft sway templates' => 'sind vorgefertigte Layout- und Inhaltsvorlagen, mit denen Sway-Präsentationen schneller erstellt werden können.',
            'microsoft delve' => 'zeigt kontextbezogen relevante Dokumente und Informationen aus Microsoft 365 basierend auf Zusammenarbeit und Zugriffen an.',
            'microsoft viva' => 'ist die Plattform für Employee Experience, Kommunikation, Lernen, Wissen und Produktivität in Microsoft 365.',
            'microsoft viva learning' => 'integriert Lernangebote aus internen und externen Quellen in Teams und den Arbeitsalltag von Mitarbeitenden.',
            'microsoft viva topics' => 'ordnet Wissen mithilfe von KI thematisch und macht Fachbegriffe, Personen und Inhalte im Arbeitskontext auffindbar.',
            'microsoft viva connections' => 'bringt Unternehmenskommunikation, Dashboard-Inhalte und interne Portale zentral in Microsoft Teams zusammen.',
            'microsoft viva goals' => 'unterstützt Zielmanagement nach OKR-Prinzipien und verknüpft strategische Ziele mit messbaren Ergebnissen.',
            'microsoft yammer' => 'ist das frühere Enterprise-Social-Network von Microsoft und wurde funktional in Viva Engage überführt.',
            'microsoft lists' => 'ist eine App zum strukturierten Verwalten, Nachverfolgen und Freigeben von Listeninformationen in Microsoft 365.',
            'microsoft lists rules' => 'sind regelbasierte Automatisierungen in Microsoft Lists für Benachrichtigungen, Änderungen und Statuswechsel.',
            'microsoft myanalytics' => 'analysiert persönliche Arbeitsmuster und gibt Hinweise zu Fokuszeit, E-Mail-Verhalten und Meeting-Aufwand.',
            'microsoft compliance center' => 'ist das Verwaltungsportal für Compliance-, Datenschutz- und Informationsschutzfunktionen in Microsoft 365.',
            'microsoft compliance manager' => 'bewertet Compliance-Risiken, Maßnahmen und Reifegrade anhand von Standards, Anforderungen und Kontrollkatalogen.',
            'microsoft security & compliance center' => 'war die zentrale Verwaltungsoberfläche für Sicherheits- und Compliance-Funktionen vor der Aufteilung in spezialisierte Portale.',
            'microsoft secure score' => 'bewertet die Sicherheitskonfiguration einer Microsoft-365-Umgebung und empfiehlt priorisierte Verbesserungen.',
            'microsoft graph api' => 'ist die zentrale Programmierschnittstelle für den Zugriff auf Daten, Benutzer, Gruppen und Dienste in Microsoft 365.',
            'microsoft 365 groups' => 'sind gemeinsame Identitäts- und Kollaborationscontainer für Teams, Planner, SharePoint und Outlook-Ressourcen.',
            'microsoft 365 lighthouse' => 'ist ein Verwaltungswerkzeug für Partner und Dienstleister, um mehrere kleinere Microsoft-365-Mandanten zentral zu betreuen.',
            'microsoft 365 roadmap' => 'zeigt geplante, ausgerollte und geänderte Funktionen aus Microsoft 365 zur Release- und Change-Planung.',
            'microsoft 365 admin center' => 'ist das zentrale Portal für Benutzer, Lizenzen, Dienste, Richtlinien und Einstellungen in Microsoft 365.',
            'microsoft 365 message center' => 'liefert Service-Nachrichten und Änderungsinformationen zu neuen, geänderten oder auslaufenden Microsoft-365-Funktionen.',
            'microsoft 365 service health' => 'zeigt den aktuellen Gesundheitszustand von Diensten sowie Störungen, Wartungen und Service-Hinweise in Microsoft 365 an.',
            'microsoft 365 apps for enterprise' => 'bezeichnet die unternehmensgeeignete Office-App-Suite mit Desktopanwendungen und Cloudanbindung aus Microsoft 365.',
            'microsoft 365 apps admin center' => 'ist das Verwaltungsportal für Servicing, Bereitstellung und Gesundheitsdaten der Microsoft-365-Apps.',
            'microsoft teams premium' => 'erweitert Teams um zusätzliche Funktionen für Meetings, Sicherheit, Personalisierung und intelligente Zusammenfassungen.',
            'microsoft teams rooms' => 'umfasst Hardware- und Softwarelösungen, um Besprechungsräume nativ in Microsoft Teams zu integrieren.',
            'microsoft teams live events' => 'ermöglichte groß angelegte Live-Übertragungen in Teams und wurde schrittweise durch neuere Event-Formate ergänzt oder ersetzt.',
            'microsoft teams breakout rooms' => 'teilen Meeting-Teilnehmer in separate Gruppenräume auf, um Workshops oder Kleingruppenarbeit in Teams zu unterstützen.',
            'microsoft teams shifts' => 'ist die Dienstplan- und Schichtverwaltungsfunktion in Teams für Frontline- und Einsatzplanung.',
            'microsoft teams calling' => 'fasst Cloud-Telefonie, Rufnummern, Anrufsteuerung und Voicemail-Funktionen innerhalb von Teams zusammen.',
            'microsoft teams education' => 'ist die auf Bildungsumgebungen ausgerichtete Nutzung von Teams mit Klassenfunktionen und Lernwerkzeugen.',
            'microsoft teams approval workflow' => 'ermöglicht Genehmigungsprozesse direkt in Teams und bindet Freigaben in Kollaborationsabläufe ein.',
            'microsoft teams webinar' => 'stellt Funktionen für registrierungspflichtige Online-Veranstaltungen mit Teilnehmerverwaltung in Teams bereit.',
            'microsoft teams town hall' => 'ist das Format für große interne Online-Veranstaltungen und Unternehmensübertragungen in Teams.',
            'microsoft planner hub' => 'bündelt Planner-Boards und Aufgabenansichten in einer zentralen Übersicht für Planung und Nachverfolgung.',
            'microsoft planner charts' => 'visualisieren Aufgabenstände, Fortschritte und Verteilungen in Microsoft Planner anhand integrierter Diagramme.',
            'microsoft project' => 'ist die Projektmanagementlösung von Microsoft für Planung, Ressourcen, Zeitachsen und Projektsteuerung.',
            'microsoft visio' => 'ist das Diagramm- und Visualisierungstool von Microsoft für Organigramme, Prozesse, Netzwerke und technische Darstellungen.',
            'microsoft onenote' => 'ist das digitale Notizbuch von Microsoft für strukturierte Notizen, Wissenssammlung und Zusammenarbeit.',
            'microsoft outlook online' => 'ist die webbasierte Variante von Outlook für E-Mail, Kalender, Kontakte und Aufgaben.',
            'microsoft outlook mobile' => 'ist die mobile Outlook-App für E-Mail, Kalender und Kontakte auf Smartphones und Tablets.',
            'microsoft word online' => 'ist die browserbasierte Version von Microsoft Word für gemeinsames Erstellen und Bearbeiten von Dokumenten.',
            'microsoft excel online' => 'ist die browserbasierte Version von Microsoft Excel für Tabellen, Auswertungen und gemeinsame Bearbeitung.',
            'microsoft powerpoint online' => 'ist die webbasierte Version von PowerPoint für Präsentationen, Zusammenarbeit und Freigaben im Browser.',
            'microsoft office for the web' => 'bezeichnet die browserbasierten Office-Anwendungen für Word, Excel, PowerPoint und weitere Microsoft-365-Dienste.',
            'microsoft office scripts' => 'ermöglicht Automatisierungen in Excel für das Web mithilfe von TypeScript-basierten Skripten.',
            'microsoft office lens' => 'ist die App von Microsoft zum Erfassen, Zuschneiden und Digitalisieren von Dokumenten, Tafeln und Whiteboards.',
            'microsoft office deployment tool' => 'ist das Werkzeug zur automatisierten Bereitstellung und Konfiguration von Microsoft-Office-Installationen.',
            'microsoft editor' => 'ist der Schreibassistent von Microsoft für Rechtschreibung, Grammatik, Stil und Formulierungsvorschläge.',
            'microsoft power bi' => 'ist die Analyse- und Reporting-Plattform von Microsoft für Dashboards, Berichte und Datenvisualisierung.',
            'microsoft power platform' => 'fasst Power BI, Power Apps, Power Automate und weitere Dienste für Low-Code, Daten und Automatisierung zusammen.',
            'microsoft power virtual agents' => 'ermöglicht die Erstellung dialogbasierter Bots ohne klassische Softwareentwicklung.',
            'microsoft endpoint manager' => 'war die zusammengeführte Verwaltungssicht für Intune und Konfigurationsmanagement in Microsoft-Endgeräteumgebungen.',
            'microsoft cloud app security' => 'war die frühere Bezeichnung für Microsoft Defender for Cloud Apps zur Überwachung und Kontrolle von SaaS-Diensten.',
            'microsoft defender for identity' => 'erkennt identitätsbezogene Angriffe und verdächtige Aktivitäten in hybriden Active-Directory-Umgebungen.',
            'microsoft defender for cloud apps' => 'überwacht Cloud-Anwendungen, erkennt Risiken und setzt Richtlinien für SaaS-Nutzung und Datenflüsse durch.',
            'microsoft defender xdr' => 'korreliert Sicherheitsdaten aus Identitäten, Endpunkten, E-Mail und Anwendungen zu einem erweiterten Bedrohungsbild.',
            'microsoft advanced ediscovery' => 'unterstützt juristische und Compliance-Teams bei Suche, Sichtung und Aufbereitung großer Datenbestände.',
            'microsoft exchange hybrid' => 'beschreibt den kombinierten Betrieb von lokalem Exchange und Exchange Online in einer integrierten Umgebung.',
            'microsoft sharepoint hub sites' => 'verknüpfen verwandte SharePoint-Websites unter gemeinsamer Navigation, Suche und Gestaltung.',
            'microsoft search' => 'ist die organisationsweite Suche von Microsoft 365 über Inhalte, Personen, Orte und Ressourcen hinweg.',
            'microsoft bookings mobile' => 'bezeichnet die mobile Nutzung von Microsoft Bookings zur Terminverwaltung unterwegs.',
            'microsoft loop components' => 'sind einzeln einbettbare, synchronisierte Inhaltselemente aus Microsoft Loop für Chats, Mails und Meetings.',
            'microsoft loop workspaces' => 'sind gemeinsame Arbeitsbereiche in Microsoft Loop zur Bündelung von Seiten, Komponenten und Projektwissen.',
            'microsoft syntex' => 'nutzt KI und Inhaltsverarbeitung, um Dokumente zu klassifizieren, Informationen zu extrahieren und Content-Prozesse zu unterstützen.',
            'benutzerprinzipal' => 'ist ein Identitätsobjekt in einem Verzeichnisdienst, das einen Benutzer oder dessen Sicherheitskontext repräsentiert.',
            'dienstprinzipal' => 'ist das Sicherheitsobjekt einer Anwendung oder eines Dienstes in Microsoft Entra ID für authentifizierten Ressourcenzugriff.',
            'identity access management' => 'beschreibt das Zusammenspiel aus Richtlinien, Prozessen und Technologien zur Verwaltung digitaler Identitäten und Zugriffe.',
            'identity protection & governance' => 'fasst Funktionen für Risikoerkennung, Lebenszyklussteuerung, Prüfungen und kontrollierte Zugriffsvergabe zusammen.',
            'identitätssicherheitsbewertung' => 'bewertet den Sicherheitszustand von Identitäten anhand empfohlener Maßnahmen, Risiken und Schutzkonfigurationen.',
            'mandant bzw. tenant' => 'bezeichnet die organisatorisch getrennte Microsoft-365- oder Entra-Instanz einer Organisation.',
            'privileged identity management' => 'ermöglicht zeitlich begrenzte, genehmigte und protokollierte Aktivierungen privilegierter Rollen in Entra ID.',
            'single sign-on' => 'ermöglicht Benutzern, sich einmal anzumelden und anschließend auf mehrere verbundene Anwendungen zuzugreifen.',
            'tenant id' => 'ist die eindeutige Kennung einer Microsoft-Entra- oder Microsoft-365-Mandanteninstanz.',
            'zugriffstoken' => 'ist das Sicherheitstoken, das nach erfolgreicher Authentifizierung für autorisierte API- oder Ressourcenzugriffe verwendet wird.',
            'benutzerprinzipalname' => 'ist der eindeutige Anmeldename eines Benutzers in Form eines UPN ähnlich einer E-Mail-Adresse.',
            'app-registrierung' => 'legt eine Anwendung in Entra ID an, damit Authentifizierung, Berechtigungen und API-Zugriffe konfiguriert werden können.',
            'lizenzzuweisung' => 'ordnet Benutzern oder Gruppen die benötigten Microsoft-365-Lizenzpläne und Serviceberechtigungen zu.',
            'gastzugriff' => 'ermöglicht externen Personen kontrollierten Zugriff auf Ressourcen in Teams, SharePoint oder anderen Microsoft-365-Diensten.',
            'freigegebenes postfach' => 'ist ein Exchange-Postfach, das von mehreren Benutzern gemeinsam genutzt und ohne separates Login verwaltet werden kann.',
            'retention label' => 'klassifiziert Inhalte nach Aufbewahrungs- und Löschregeln für Records-Management und Compliance-Zwecke.',
            'datenresidenz' => 'beschreibt, in welchen geografischen Regionen Daten gespeichert, verarbeitet oder repliziert werden dürfen.',
            'azure subscription' => 'ist die Abrechnungs- und Verwaltungsgrenze für Azure-Ressourcen, Berechtigungen und Budgets.',
            'subscription' => 'ist das Azure-Abonnement, unter dem Ressourcen bereitgestellt, abgerechnet und administrativ verwaltet werden.',
            'subscription id' => 'ist die eindeutige Kennung eines Azure-Abonnements für APIs, Deployments und Verwaltungsvorgänge.',
            ...
            'azure active directory' => 'ist die frühere Produktbezeichnung von Microsoft Entra ID für Identitäts- und Zugriffsverwaltung in der Cloud.',
            'azure ad connect' => 'synchronisiert lokale Verzeichnisobjekte mit Microsoft Entra ID und unterstützt hybride Identitätsmodelle.',
            'app-id / client-id' => 'ist die eindeutige Kennung einer registrierten Anwendung oder eines Dienstes in Microsoft Entra ID.',
            'anwendungsmanifest' => 'beschreibt Konfiguration, Berechtigungen und technische Eigenschaften einer registrierten Anwendung.',
            'azure resource manager' => 'ist die Steuerungsebene von Azure für Bereitstellung, Verwaltung und Organisation von Ressourcen.',
            'azure resource manager templates' => 'sind deklarative JSON-Vorlagen, mit denen Azure-Ressourcen reproduzierbar bereitgestellt werden können.',
            'azure resource graph' => 'ermöglicht schnelle, abonnementübergreifende Abfragen zu Azure-Ressourcen und deren Metadaten.',
            'azure automation' => 'automatisiert wiederkehrende Verwaltungsaufgaben in Azure über Runbooks, Zustandsverwaltung und Updateprozesse.',
            'azure batch' => 'führt große Mengen paralleler Rechenaufgaben oder HPC-Workloads auf verwalteter Azure-Infrastruktur aus.',
            'azure blueprints' => 'stellte Vorlagen für Governance, Richtlinien und Standardressourcen bereit und wurde weitgehend von neueren Governance-Ansätzen abgelöst.',
            'azure cli' => 'ist die Kommandozeilenschnittstelle für Bereitstellung, Verwaltung und Automatisierung von Azure-Ressourcen.',
            'azure cache for redis' => 'stellt einen verwalteten In-Memory-Cache bereit, um Anwendungen mit schnellen Datenzugriffen zu beschleunigen.',
            'azure cognitive services' => 'bietet APIs und Dienste für Sprach-, Bild-, Entscheidungs- und KI-Funktionen in Anwendungen.',
            'azure communication services' => 'ermöglicht die Einbindung von Chat-, Telefonie-, Video- und SMS-Funktionen in eigene Anwendungen.',
            'azure container instances' => 'startet Container schnell und ohne Clusterbetrieb direkt als verwaltete Instanzen in Azure.',
            'azure cosmos db' => 'ist die global verteilte NoSQL-Datenbank von Azure für hochverfügbare und horizontal skalierbare Anwendungen.',
            'azure data factory' => 'ist der Integrationsdienst für Datenpipelines, ETL/ELT-Prozesse und orchestrierte Datenbewegungen.',
            'azure data lake' => 'bezeichnet den skalierbaren Datenspeicher für analytische und Big-Data-nahe Workloads in Azure.',
            'azure databricks' => 'ist die verwaltete Apache-Spark-Plattform in Azure für Datenverarbeitung, Analyse und Machine Learning.',
            'azure dedicated host' => 'stellt physischen Azure-Host-Server exklusiv für einen Kunden zur Verfügung.',
            'azure devops' => 'bündelt Werkzeuge für Planung, Quellcodeverwaltung, Pipelines, Artefakte und Testmanagement.',
            'azure disk storage' => 'liefert verwaltete Datenträger für virtuelle Maschinen mit unterschiedlichen Leistungs- und Verfügbarkeitsklassen.',
            'azure event grid' => 'verteilt Ereignisse nahezu in Echtzeit zwischen Azure-Diensten und Anwendungen nach dem Publish-Subscribe-Prinzip.',
            'azure event hubs' => 'ist die skalierbare Event-Streaming-Plattform von Azure für Telemetrie- und Datenströme mit hohem Durchsatz.',
            'azure expressroute' => 'stellt private, dedizierte Netzwerkverbindungen zwischen Azure und eigener Infrastruktur bereit.',
            'azure firewall' => 'ist die verwaltete, zustandsbehaftete Netzwerkfirewall von Azure für zentral kontrollierten Datenverkehr.',
            'azure firewall manager' => 'vereinfacht die zentrale Richtlinien- und Sicherheitsverwaltung über mehrere Azure Firewalls hinweg.',
            'azure iot hub' => 'ist der zentrale Dienst für die sichere Kommunikation zwischen IoT-Geräten und Azure-Anwendungen.',
            'azure lighthouse' => 'ermöglicht Dienstleistern und zentralen Teams, Azure-Ressourcen über mehrere Mandanten hinweg delegiert zu verwalten.',
            'azure load balancer' => 'verteilt Netzwerkverkehr auf mehrere Ziele, um Hochverfügbarkeit und Lastverteilung auf Layer 4 zu unterstützen.',
            'azure logic apps' => 'erstellen automatisierte Workflows zwischen Diensten, APIs und Geschäftssystemen in Low-Code-Form.',
            'azure logic app connectors' => 'sind vorgefertigte Integrationsbausteine für Datenquellen, Dienste und Geschäftsapplikationen in Logic Apps.',
            'azure machine learning' => 'ist die Plattform von Azure für Entwicklung, Training, Bereitstellung und Betrieb von ML-Modellen.',
            'azure managed applications' => 'ermöglicht es Anbietern, vollständige, verwaltete Lösungen kontrolliert in Kundensubscriptions bereitzustellen.',
            'azure migrate' => 'unterstützt bei Bewertung, Planung und Migration von Servern, Datenbanken und Anwendungen nach Azure.',
            'azure monitor logs' => 'bieten die protokollbasierte Analyseebene in Azure Monitor für Abfragen, Warnungen und Auswertungen.',
            'azure network watcher' => 'stellt Diagnose- und Analysewerkzeuge für Netzwerke, Routing, Verbindungen und Datenflüsse in Azure bereit.',
            'azure policy insights' => 'liefert Auswertungen, Detailinformationen und Historien zur Einhaltung von Azure Policies.',
            'azure private endpoint' => 'bindet einen Azure-Dienst mit privater IP-Adresse direkt in ein virtuelles Netzwerk ein.',
            'azure private link' => 'ermöglicht privaten Zugriff auf PaaS-Dienste und Anbieterressourcen über das Azure-Backbone-Netzwerk.',
            'azure purview' => 'war die frühere Bezeichnung für den Microsoft-Purview-Datenkatalog und Daten-Governance-Dienst in Azure-Kontexten.',
            'azure security center' => 'war das Sicherheitsportal für Empfehlungen und Schutzfunktionen und ging in Microsoft Defender for Cloud auf.',
            'azure sentinel' => 'ist das cloudnative SIEM- und SOAR-Angebot von Microsoft zur Erkennung, Analyse und Reaktion auf Sicherheitsvorfälle.',
            'azure service endpoint' => 'erweitert ein virtuelles Netzwerk, damit ausgewählte Azure-Dienste über optimierte Netzwerkpfade erreichbar sind.',
            'azure service health' => 'informiert über Ausfälle, Wartungen und Dienstprobleme, die eigene Azure-Ressourcen beeinflussen können.',
            'azure service bus' => 'ist der Messaging-Dienst von Azure für asynchrone Kommunikation über Queues und Topics.',
            'azure signalr service' => 'stellt verwaltete Echtzeitkommunikation für Web- und App-Szenarien mit SignalR bereit.',
            'azure spring cloud' => 'war der verwaltete Azure-Dienst für Spring-basierte Java-Anwendungen mit Plattform- und Betriebsintegration.',
            'azure stack' => 'bezeichnet die Hybrid-Plattformfamilie, mit der Azure-nahe Dienste und Betriebsmodelle lokal bereitgestellt werden können.',
            'azure synapse analytics' => 'vereint Data Warehousing, Big-Data-Analyse und Integrationsfunktionen in einer gemeinsamen Plattform.',
            'azure table storage' => 'ist der schemalose NoSQL-Schlüsselspeicher in Azure Storage für einfache, skalierbare Tabellendaten.',
            'azure traffic manager' => 'steuert DNS-basiert die Verteilung eingehender Anfragen auf globale oder regionale Zielendpunkte.',
            'azure update management' => 'koordiniert die Bewertung und Installation von Updates auf unterstützten Azure- und Hybrid-Systemen.',
            'azure vpn gateway' => 'stellt verschlüsselte Site-to-Site- oder Point-to-Site-Verbindungen zwischen Azure und anderen Netzwerken bereit.',
            'azure virtual machine scale sets' => 'ermöglichen Gruppen identischer virtueller Maschinen mit automatischer Skalierung und Lastverteilung.',
            'azure virtual network peering' => 'verbindet zwei virtuelle Netzwerke direkt miteinander, damit sie über private Azure-Routen kommunizieren können.',
            'azure virtual wan' => 'ist die globale Netzwerkplattform von Azure für WAN-, Branch-, VPN- und ExpressRoute-Szenarien.',
            'azure webjobs' => 'führen Hintergrundprozesse oder zeitgesteuerte Aufgaben im Kontext von Azure App Service aus.',
            'azure workbooks' => 'sind interaktive Berichts- und Dashboard-Ansichten für Metriken, Logs und Betriebsdaten in Azure.',
            'service principal' => 'ist die Azure- beziehungsweise Entra-Darstellung einer Anwendung für authentifizierten Ressourcenzugriff.',
            'user assigned managed identity' => 'ist eine separat verwaltete, wiederverwendbare Managed Identity für mehrere Azure-Ressourcen.',
            'system assigned managed identity' => 'ist eine automatisch an eine einzelne Azure-Ressource gebundene Managed Identity.',
            'availability set' => 'verteilt virtuelle Maschinen auf Fehler- und Update-Domänen, um gemeinsame Ausfälle zu reduzieren.',
            'availability zone' => 'ist ein physisch getrennter Azure-Standort innerhalb einer Region zur Erhöhung der Ausfallsicherheit.',
            'azure arc' => 'erweitert Azure-Verwaltung, Richtlinien und Überwachung auf Server, Kubernetes und Dienste außerhalb von Azure.',
            'azure advisor' => 'liefert Empfehlungen zu Kosten, Leistung, Sicherheit, Zuverlässigkeit und Betrieb bewährter Azure-Konfigurationen.',
            'azure cost management + billing' => 'fasst Kostenanalyse, Budgets, Abrechnungen und Verbrauchsauswertungen für Azure zusammen.',
            'azure api management' => 'ist die Plattform von Azure zum Veröffentlichen, Schützen, Versionieren und Überwachen von APIs.',
            'azure dns' => 'stellt autoritative DNS-Zonen und Namensauflösung für Internet- und Azure-basierte Dienste bereit.',
            'azure ddos protection' => 'schützt öffentliche Azure-Ressourcen vor volumetrischen DDoS-Angriffen durch automatische Abwehrmechanismen.',
            'azure image builder' => 'automatisiert die Erstellung standardisierter VM-Images für Azure- und Hybrid-Bereitstellungen.',
            'azure backup vault' => 'ist der Tresor für moderne Azure-Backup-Szenarien und die Verwaltung gesicherter Datenobjekte.',
            'azure recovery services vault' => 'ist der klassische Azure-Tresor für Backup- und Site-Recovery-Konfigurationen und Wiederherstellungspunkte.',
            'azure app configuration' => 'verwaltet zentrale Anwendungseinstellungen und Feature Flags für Cloud-Anwendungen.',
            'azure database for postgresql' => 'ist der verwaltete PostgreSQL-Datenbankdienst von Azure für relationale Workloads.',
            'azure database for mysql' => 'ist der verwaltete MySQL-Datenbankdienst von Azure für relationale Anwendungen und Plattformdienste.',
            'azure load testing' => 'führt skalierbare Lasttests in Azure aus, um Leistungsgrenzen und Verhalten unter Last zu prüfen.',
            'azure chaos studio' => 'unterstützt kontrollierte Ausfall- und Resilienztests, um Systeme gezielt gegen Störungen zu prüfen.',
            'bicep' => 'ist die domänenspezifische Sprache von Microsoft für deklarative Azure-Infrastruktur als Code.',
            'management group' => 'ordnet mehrere Azure-Subscriptions hierarchisch, um Governance und Richtlinien zentral zu steuern.',
            'role based access control' => 'steuert Zugriffsrechte in Azure über Rollen, Zuweisungen und definierte Geltungsbereiche.',
        ...
        return [
            'm365' => [
                ...
                'entries' => [
                    ...
                    'Mandant bzw. Tenant',
                    ['title' => 'Privileged Identity Management', 'synonyms' => ['PIM']],
                    'Single Sign-On',
                    'Tenant ID',
                    'Zugriffstoken',
                    ['title' => 'Benutzerprinzipalname', 'synonyms' => ['UPN']],
                    'App-Registrierung',
                    'Lizenzzuweisung',
                    'Gastzugriff',
            ...
            'azure-cloud' => [
                ...
                'entries' => [
                    ...
                    'Azure Landing Zone',
                    'Cost Management',
                    ['title' => 'Azure Active Directory', 'synonyms' => ['Azure AD']],
                    'Azure AD Connect',
                    ['title' => 'APP-ID / Client-ID', 'synonyms' => ['App ID', 'Client ID']],
                    'Anwendungsmanifest',
                    'Azure Resource Manager',
                    ['title' => 'Azure Resource Manager Templates', 'synonyms' => ['ARM Templates']],
