                                ...
                                <?php if ($linkedSpeaker !== null || $linkedCompany !== null): ?>
                                    <div class="cms-excomp-linked">
                                        ...
                                        <?php if ($linkedCompany !== null): ?>
                                            <a class="cms-excomp-linked-item" href="<?= $e(rtrim((string) SITE_URL, '/') . '/companies?q=' . rawurlencode($linkedCompanyName)) ?>">🏢 <?= $e($linkedCompanyName !== '' ? $linkedCompanyName : 'Company') ?></a>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
