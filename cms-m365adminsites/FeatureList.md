...
- **Umsetzung in diesem Plugin:** Public-Panel mit filterbaren Highlights (Severity/Workload), konfigurierbar über Adminbereich (`Inhalte & Texte`), inkl. de/en-Labels und formatierbarem Feed (`severity|workload|title|url`).
...
- **Umsetzung in diesem Plugin:** Neues Public-Shortcut-Panel mit drei Presets (Identity, Cloud App, Platform/Device), konfigurierbaren de/en-Texten und direktem What-If-Einstieg.
...
- **Status:** ❌ Zurückgestellt (high effort)
