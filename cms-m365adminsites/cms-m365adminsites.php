...
final class CMS_M365ADMINSITES
{
    ...
    private function init_hooks(): void
    {
        ...
        \CMS\Hooks::addFilter('admin_menu_items', [CMS_M365ADMINSITES_Admin_Menu::class, 'add_menu_items'], 10);
        \CMS\Hooks::addAction('register_routes', [CMS_M365ADMINSITES_Admin_Pages::class, 'register_admin_routes'], 10);
