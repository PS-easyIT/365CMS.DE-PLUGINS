    ...
    <main class="contact-main" aria-labelledby="contact-form-title">
        <div class="booking-service-wrap">
            ...
            <section class="booking-service-trust" aria-label="Vertrauensmerkmale">
                <span aria-label="SSL-gesichert">🔒 SSL-gesichert</span>
                <span aria-label="Sofortige Bestätigung">📧 Sofortige Bestätigung</span>
                <span aria-label="DSGVO-konform">🛡️ DSGVO-konform</span>
            </section>
        </div>
    </main>
