...
<body class="contact-page contact-template-booking-event">
    ...
    <main class="contact-main">
        <div class="booking-event-card">
            <div class="booking-event-header">
                <div class="booking-event-badges">
            ...
            <div class="booking-event-body">
                <h3>📝 Veranstaltung anfragen</h3>
