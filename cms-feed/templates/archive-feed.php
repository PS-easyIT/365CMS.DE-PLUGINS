...
<main class="fd-main">
    ...
    <div class="fd-pagination">
        ...
        <a href="?page=<?php echo $pagination['current'] - 1; ?><?php echo !empty($search) ? '&q=' . urlencode($search) : ''; ?>"
           class="fd-pagination__btn">← Zurück</a>
        <?php endif; ?>

        <span class="fd-pagination__info">
            Seite <?php echo $pagination['current']; ?> von <?php echo $pagination['total_pages']; ?>
        </span>
