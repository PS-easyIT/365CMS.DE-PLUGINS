...
trait CMS_M365LIC_Page_Settings_Trait
{
    public function render_settings_page(): void
    {
        ...
        $alternativeOfferCount = count($alternativeOffers);
        $euAlternativeOfferCount = count($euAlternativeOffers);
        $euAiAlternativeOfferCount = count($euAiAlternativeOffers);
        ?>
        ...
        <div class="admin-card m365lic-tab-card m365lic-tab-card--settings">
            <form method="POST" class="admin-form">
                ...
                <?php elseif ($tab === 'alternatives'): ?>
                    ...
                    <div class="m365lic-accordion-stack">
                        <details class="m365lic-accordion" open>
                            <summary class="m365lic-accordion__summary">
                                <span>
                                    <span class="m365lic-section-kicker">Normale Alternativen</span>
                                    <strong class="m365lic-accordion__title">Standard-Vergleichsanbieter verwalten</strong>
                                </span>
                                <span class="m365lic-accordion__meta"><?php echo (int) $alternativeOfferCount; ?> Einträge</span>
                            </summary>
                            <div class="m365lic-accordion__body">
                        ...
                        <details class="m365lic-accordion">
                            <summary class="m365lic-accordion__summary">
                                <span>
                                    <span class="m365lic-section-kicker">EU-Alternativen</span>
                                    <strong class="m365lic-accordion__title">Europäische Anbieter für den Public-Vergleich</strong>
                                </span>
                                <span class="m365lic-accordion__meta"><?php echo (int) $euAlternativeOfferCount; ?> Einträge</span>
                            </summary>
                            <div class="m365lic-accordion__body">
                                <div class="m365lic-inline-head">
                                    <div>
                        ...
                        <details class="m365lic-accordion">
                            <summary class="m365lic-accordion__summary">
                                <span>
                                    <span class="m365lic-section-kicker">Europäische KI- & Copilot-Alternativen</span>
                                    <strong class="m365lic-accordion__title">Copilot-Gegenstücke separat pflegen</strong>
                                </span>
                                <span class="m365lic-accordion__meta"><?php echo (int) $euAiAlternativeOfferCount; ?> Einträge</span>
                            </summary>
                            <div class="m365lic-accordion__body">
                                <div class="m365lic-inline-head">
                                    <div>
