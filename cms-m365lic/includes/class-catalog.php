...
final class CMS_M365LIC_Catalog
{
    ...
    public static function package_seeds(): array
    {
        $packages = [
            ...
            ['slug' => 'm365-apps-enterprise', 'name' => 'Microsoft 365 Apps for enterprise', 'kind' => 'base', 'category' => 'apps', 'audience' => 'knowledge', 'pricing_basis' => 'per_user', 'description' => 'Enterprise-Variante der Desktop- und Web-Apps mit OneDrive.', 'features' => ['office_desktop', 'office_web', 'onedrive', 'forms', 'stream'], 'tags' => ['apps', 'enterprise', 'copilot_enterprise_eligible', 'copilot_chat_eligible'], 'prerequisite_tags' => [], 'public_price' => null, 'member_price' => null, 'group_price' => null, 'currency' => 'USD', 'pricing_note' => '', 'source_note' => 'Apps for enterprise ist direkte Copilot-Voraussetzung.', 'sort_order' => 75, 'is_active' => 1],
    ...
    private static function seed_price_map(): array
    {
        ...
        return [
            ...
            'm365-apps-enterprise' => $perUser(12.00, 'Microsoft 365 Pricing Updates Snippet: Microsoft 365 Apps for enterprise 12 USD pro Benutzer/Monat.'),
            ...
            'm365-business-premium' => $perUser(22.00, 'Microsoft 365 Pricing Updates Snippet: Business Premium 22 USD pro Benutzer/Monat.'),
            'office-365-e1' => $perUser(10.00, 'Microsoft 365 Pricing Updates Snippet: Office 365 E1 10 USD pro Benutzer/Monat.'),
            'office-365-e3' => $perUser(23.00, 'Microsoft 365 Pricing Updates Snippet: Office 365 E3 23 USD pro Benutzer/Monat.'),
            'office-365-e5' => $perUser(38.00, 'Microsoft 365 Pricing Updates Snippet: Office 365 E5 38 USD pro Benutzer/Monat.'),
            'm365-e3' => $perUser(36.00, 'Microsoft 365 Pricing Updates Snippet: Microsoft 365 E3 36 USD pro Benutzer/Monat.'),
            'm365-e5' => $perUser(57.00, 'Microsoft 365 Pricing Updates Snippet: Microsoft 365 E5 57 USD pro Benutzer/Monat.'),
