...
<div class="nl-admin-shell">
    ...
    <div class="dashboard-grid">
        <div class="stat-card"><div class="stat-icon">👥</div><div class="stat-number"><?php echo number_format((int) ($stats['subscribers'] ?? 0)); ?></div><div class="stat-label">Abonnenten</div></div>
        <div class="stat-card"><div class="stat-icon">✅</div><div class="stat-number"><?php echo number_format((int) ($stats['active_subscribers'] ?? 0)); ?></div><div class="stat-label">Aktiv</div></div>
        <div class="stat-card"><div class="stat-icon">⏳</div><div class="stat-number"><?php echo number_format((int) ($stats['pending_subscribers'] ?? 0)); ?></div><div class="stat-label">Pending</div></div>
        <div class="stat-card"><div class="stat-icon">🧩</div><div class="stat-number"><?php echo number_format((int) ($stats['templates'] ?? 0)); ?></div><div class="stat-label">Templates</div></div>
        <div class="stat-card"><div class="stat-icon">📨</div><div class="stat-number"><?php echo number_format((int) ($stats['campaigns'] ?? 0)); ?></div><div class="stat-label">Kampagnen</div></div>
        <div class="stat-card"><div class="stat-icon">🚀</div><div class="stat-number"><?php echo number_format((int) ($stats['ready_campaigns'] ?? 0)); ?></div><div class="stat-label">Versandbereit</div></div>
    </div>

    <div class="nl-card-grid">
        <div class="nl-info-card">
            <span class="nl-info-card__eyebrow">Sender</span>
            <span class="nl-info-card__value"><?php echo htmlspecialchars((string) ($settings['sender_name'] ?? '365 Network')); ?></span>
            <span class="nl-info-card__text"><?php echo htmlspecialchars((string) ($settings['sender_email'] ?? 'newsletter@example.com')); ?></span>
        </div>
        <div class="nl-info-card">
    ...
    <div class="nl-feature-grid">
        <a href="/admin/plugins/newsletter-dashboard/newsletter-subscribers" class="nl-feature-card">
            <span class="nl-feature-card__icon">👥</span>
            <span>
                ...
                <div class="users-table-container">
                    <table class="users-table">
                        ...
                        <?php foreach ($subscribers as $subscriber): ?>
                            <tr>
                                <td><a href="/admin/plugins/newsletter-dashboard/newsletter-subscribers?edit=<?php echo (int) $subscriber['id']; ?>" class="nl-admin-link"><?php echo htmlspecialchars((string) $subscriber['email']); ?></a></td>
                                <td><?php echo htmlspecialchars((string) ($subscriber['segment_slug'] ?: 'general')); ?></td>
                                <td><span class="status-badge <?php echo ($subscriber['status'] ?? '') === 'active' ? 'active' : 'inactive'; ?>"><?php echo htmlspecialchars((string) $subscriber['status']); ?></span></td>
                                <td><?php echo htmlspecialchars((string) ($subscriber['source'] ?? 'admin')); ?></td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
                    </table>
                ...
                <?php else: ?>
                    <ul class="nl-compact-list">
                        <?php foreach ($campaigns as $campaign): ?>
                            <li>
                                <span>
                                    <strong><?php echo htmlspecialchars((string) $campaign['name']); ?></strong>
                                    <small><?php echo htmlspecialchars((string) ($campaign['template_name'] ?? 'Ohne Template')); ?></small>
                                </span>
                                <span class="nl-soft-badge nl-soft-badge--<?php echo htmlspecialchars((string) ($campaign['status'] ?? 'draft')); ?>"><?php echo htmlspecialchars((string) ($campaign['status'] ?? 'draft')); ?></span>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                <?php endif; ?>
