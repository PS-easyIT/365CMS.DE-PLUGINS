...
<div class="pr-admin-shell">
    ...
    <div class="pr-card-grid">
        <div class="pr-info-card"><span class="pr-info-card__eyebrow">Archiv-Titel</span><span class="pr-info-card__value"><?php echo htmlspecialchars((string) ($settings['archive_title'] ?? 'Promotions & Highlights')); ?></span><span class="pr-info-card__text">Öffentliche Überschrift der Promo-Übersicht.</span></div>
        <div class="pr-info-card"><span class="pr-info-card__eyebrow">Button-Standard</span><span class="pr-info-card__value"><?php echo htmlspecialchars((string) ($settings['default_button_label'] ?? 'Mehr erfahren')); ?></span><span class="pr-info-card__text">Voreinstellung für neue CTAs.</span></div>
    ...
    <div class="admin-card">
        <div class="pr-panel-header"><div><h3>⚙️ Grundeinstellungen</h3><p>Die Default-Werte für neue Kampagnen-Elemente und die öffentliche Übersicht.</p></div></div>
