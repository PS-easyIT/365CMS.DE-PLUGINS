...
- Microsoft 365 Network Connectivity Principles, Network Planning and Performance sowie URLs/IP Address Ranges.
...
- Microsoft 365 Copilot Licensing, Requirements und Setup.
...
| Copilot Lizenz-Pflicht-Checker | Basislizenzen, primäres Exchange-Online-Postfach, Apps, WSS und Sonderpostfächer |
...
- `license_audit_checklist.json` enthält neue Punkte für Conditional-Access-Planung, Defender-Mail-Schutz, M365-Endpoints, Copilot-Setup sowie Power-Platform-Requests und Dataverse-Kapazität.
