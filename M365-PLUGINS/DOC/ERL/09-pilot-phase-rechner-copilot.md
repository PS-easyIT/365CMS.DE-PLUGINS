...
> **Umsetzungsstand 17.05.2026:** Als Modul `copilot-pilot-calculator` im Plugin `cms-m365tools` unter `/copilot-pilot-rechner` umgesetzt und in Version `1.17.0` um Governance-/Preflight-Checkliste, aktualisierte Microsoft-Quellen, Messkriterien und FAQ-Bausteine erweitert.
