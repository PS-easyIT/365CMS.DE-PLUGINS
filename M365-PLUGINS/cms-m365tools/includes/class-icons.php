<?php
/**
 * CMS M365 Tools – Inline-SVG Icon Helper.
 *
...
final class CMS_M365CALCULATOR_Icons
{
    ...
    {
        $icon = in_array($icon, ['mailbox', 'license', 'calculator', 'shield', 'storage', 'roi', 'copilot', 'comparison', 'addons', 'phone'], true) ? $icon : 'calculator';
        ...
        return match ($icon) {
            ...
            'copilot' => '<svg' . $attrs . '><path d="M8 4h8l4 7-4 9H8l-4-9 4-7z"/><path d="M8 4l4 7-4 9"/><path d="M16 4l-4 7 4 9"/><path d="M4 11h16"/></svg>',
            'comparison' => '<svg' . $attrs . '><path d="M4 5h16"/><path d="M4 12h16"/><path d="M4 19h16"/><path d="M8 3v18"/><path d="M15 3v18"/></svg>',
            'addons' => '<svg' . $attrs . '><path d="M12 3v6"/><path d="M9 6h6"/><rect x="4" y="11" width="7" height="7" rx="1"/><rect x="13" y="11" width="7" height="7" rx="1"/><path d="M7.5 18v3"/><path d="M16.5 18v3"/></svg>',
            'phone' => '<svg' . $attrs . '><path d="M6.5 4.5l2.2-.9 2.2 5.1-1.7 1.1a9.8 9.8 0 0 0 5 5l1.1-1.7 5.1 2.2-.9 2.2c-.4 1-1.4 1.6-2.5 1.4-6.2-1-11-5.8-12-12-.2-1.1.4-2.1 1.5-2.5z"/><path d="M14 5h5v5"/><path d="M14 10l5-5"/></svg>',
