...
Hub-Settings werden typisiert geladen: `bool` wird zu Boolean gecastet, `int` zu Integer, Textwerte bleiben Strings. Die Public-Ausgabe nutzt diese Settings für Featured Card, Hero, Stats, Teaser-Band, Direkteinstieg und Toolbox.
