...
final class CMS_M365Azure_Installer
{
    ...
    private static function seed_settings(object $db, string $prefix): void
    {
        $defaults = [
            ...
            'page_overline_en' => 'Azure Overview',
            ...
            'page_intro_en' => 'Microsoft Azure provides more than 200 cloud products and services, from compute, storage, and databases to AI, security, analytics, and hybrid cloud.',
            'seo_title' => 'Microsoft Azure Services – Übersicht und Kategorien',
            'seo_title_en' => 'Microsoft Azure Services - Overview and categories',
            ...
            'source_intro_en' => 'The source list is based on the currently maintained documentation and pricing links of the displayed Azure services.',
            'source_details_label' => 'Quellen anzeigen',
            'source_details_label_en' => 'Show sources',
            'show_hero' => '1',
            'show_hero_actions' => '1',
            'show_toc' => '1',
            ...
            'show_info_note' => '1',
            'show_sources_card' => '1',
            'show_well_architected_checklist' => '1',
            'well_architected_title' => 'Well-Architected Verbesserungs-Checkliste',
            'well_architected_intro' => 'Diskussionsgrundlage für Architektur-Workshops je Kategorie.',
            'well_architected_pillar_reliability' => 'Reliability: Betriebsrisiken, Wiederherstellung und Abhängigkeiten prüfen.',
            'well_architected_pillar_security' => 'Security: Identitäten, Netzwerkzugriff, Secrets und Datenzugriffe härten.',
            'well_architected_pillar_cost' => 'Cost Optimization: Kostenhebel, Abschaltregeln und Reserved Capacity bewerten.',
            'well_architected_pillar_operational' => 'Operational Excellence: Monitoring, Alerts, Runbooks und Verantwortlichkeiten festlegen.',
            'well_architected_pillar_performance' => 'Performance Efficiency: Skalierung, Lastprofile und Engpässe validieren.',
            'well_architected_title_en' => 'Well-Architected improvement checklist',
            'well_architected_intro_en' => 'Discussion baseline for architecture workshops per category.',
            'well_architected_pillar_reliability_en' => 'Reliability: review operational risks, recovery, and dependencies.',
            'well_architected_pillar_security_en' => 'Security: harden identities, network access, secrets, and data access.',
            'well_architected_pillar_cost_en' => 'Cost Optimization: evaluate cost levers, shutdown policies, and reserved capacity.',
            'well_architected_pillar_operational_en' => 'Operational Excellence: define monitoring, alerts, runbooks, and ownership.',
            'well_architected_pillar_performance_en' => 'Performance Efficiency: validate scaling, load profiles, and bottlenecks.',
