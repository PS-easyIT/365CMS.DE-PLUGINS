...
final class CMS_365NETWORK_Database
{
    ...
    {
        $rows = [
            ['hub_section_order', 'topbar,hero,partnerband,areas,next-events,spotlight,partner-columns,toolbox,featured,stats,band', 'text', 'order', 'Reihenfolge der Public-Bereiche', 10],
            ['hub_topbar_visible', '1', 'bool', 'topbar', 'Hub-Topbar anzeigen', 10],
            ['hub_topbar_brand_prefix', '365', 'text', 'topbar', 'Brand Präfix', 20],
            ['hub_topbar_brand_accent', 'NETWORK', 'text', 'topbar', 'Brand Akzent', 30],
            ['hub_topbar_subline', 'HUB', 'text', 'topbar', 'Brand Unterzeile', 40],
            ['hub_topbar_home_url', '/', 'text', 'topbar', 'Logo Ziel-URL', 50],
            ['hub_topbar_nav1_label', 'Übersicht', 'text', 'topbar', 'Navigation 1 Label', 60],
            ['hub_topbar_nav1_url', '#areas', 'text', 'topbar', 'Navigation 1 URL', 70],
            ['hub_topbar_nav2_label', 'Speaker', 'text', 'topbar', 'Navigation 2 Label', 80],
            ['hub_topbar_nav2_url', '/speakers', 'text', 'topbar', 'Navigation 2 URL', 90],
            ['hub_topbar_nav3_label', 'Experts', 'text', 'topbar', 'Navigation 3 Label', 100],
            ['hub_topbar_nav3_url', '/experts', 'text', 'topbar', 'Navigation 3 URL', 110],
            ['hub_topbar_nav4_label', 'Unternehmen', 'text', 'topbar', 'Navigation 4 Label', 120],
            ['hub_topbar_nav4_url', '/companies', 'text', 'topbar', 'Navigation 4 URL', 130],
            ['hub_topbar_nav5_label', 'Events', 'text', 'topbar', 'Navigation 5 Label', 140],
            ['hub_topbar_nav5_url', '/events', 'text', 'topbar', 'Navigation 5 URL', 150],
            ['hub_topbar_search_visible', '1', 'bool', 'topbar', 'Topbar-Suche anzeigen', 160],
            ['hub_topbar_search_placeholder', 'Netzwerk durchsuchen …', 'text', 'topbar', 'Topbar-Suche Placeholder', 170],
            ['hub_topbar_login_visible', '1', 'bool', 'topbar', 'Login-Link anzeigen', 180],
            ['hub_topbar_login_label', 'Anmelden', 'text', 'topbar', 'Login-Link Label', 190],
            ['hub_topbar_login_url', '/login', 'text', 'topbar', 'Login-Link URL', 200],
            ['hub_topbar_bg_color', '#0a1626', 'color', 'topbar', 'Hintergrundfarbe', 210],
            ['hub_topbar_text_color', '#dfe8f2', 'color', 'topbar', 'Textfarbe', 220],
            ['hub_topbar_accent_color', '#d6951a', 'color', 'topbar', 'Akzentfarbe', 230],
            ...
            ['hub_hero_label', 'Das Microsoft-365-Netzwerk im DACH-Raum', 'text', 'hero', 'Label über H1', 10],
            ...
            ['hub_hero_layout', 'center', 'select', 'hero', 'Textausrichtung', 90],
            ...
            ['hub_hero_radius', '0', 'int', 'hero', 'Rundung (px)', 130],
