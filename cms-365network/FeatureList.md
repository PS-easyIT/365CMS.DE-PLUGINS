...
- **Status:** `skipped` - Für saubere Zielgruppen-Regeln fehlen im Plugin stabile User-Segment-/Tag-Quellen; eine robuste Umsetzung würde Cross-Plugin-/Core-Abhängigkeiten erfordern.
...
- **Status:** `skipped` - Nicht umgesetzt, um keine halbfertige Filter-UI ohne vollständige Query-/Persistenz-/A11y-Abdeckung zu liefern; Fokus auf vollständige Keyboard-Search-Qualität.
