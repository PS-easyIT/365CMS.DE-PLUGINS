...
final class CMS_M365Copilot_Installer
{
    ...
    private static function run_safely(): void
    {
        try {
            ...
            error_log('CMS M365 Copilot installer skipped: ' . $e->getMessage());
        }
    }
    ...
    private static function create_tables(): void
    {
        ...
        $table = self::validated_table_name($prefix . 'm365copilot_settings');
