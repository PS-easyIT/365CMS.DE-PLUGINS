...
- **Rough effort:** medium
- **Implemented scope:** Dashboard zeigt Dateistand (Timestamp + Dateigröße) für `readonly_suite_matrix.json`, `readonly_addon_matrix.json`, `readonly_copilot_matrix.json`.
- **Source link(s):**
...
- **Rough effort:** low
- **Implemented scope:** Dashboard-Aktionen für JSON/CSV-Export der normalisierten Suite/Add-on/Copilot-Matrix inklusive Zeitstempel.
- **Source link(s):**
...
- **Rough effort:** medium
- **Implemented scope:** Manuell auslösbare Admin-Prüfung mit URL-Status, Redirect-Ziel und Ergebnisliste auf dem Dashboard.
- **Source link(s):**
