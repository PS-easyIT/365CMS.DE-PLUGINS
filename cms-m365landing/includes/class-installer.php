...
final class CMS_M365Landing_Installer
{
    ...
    private static function seed_settings(object $db, string $prefix): void
    {
        $defaults = [
            ...
            'graph_client_id' => '',
            'graph_client_secret' => '',
            'show_service_health_panel' => '0',
            'show_message_center_panel' => '0',
            'service_health_max_items' => '5',
            'service_health_section_overline' => 'Live-Status',
            'service_health_section_overline_en' => 'Live status',
            'service_health_section_title' => 'Tenant Service Health',
            'service_health_section_title_en' => 'Tenant service health',
            'service_health_section_intro' => 'Aktuelle Vorfälle und Advisories aus Microsoft 365 Services.',
            'service_health_section_intro_en' => 'Current incidents and advisories from Microsoft 365 services.',
            'service_health_empty_text' => 'Der Service-Health-Feed ist aktuell nicht verfügbar.',
            'service_health_empty_text_en' => 'The service health feed is currently unavailable.',
            'message_center_max_items' => '5',
            'message_center_service_filter' => '',
            'message_center_section_overline' => 'Änderungsankündigungen',
            'message_center_section_overline_en' => 'Change announcements',
            'message_center_section_title' => 'Message Center Highlights',
            'message_center_section_title_en' => 'Message center highlights',
            'message_center_section_intro' => 'Wichtige angekündigte Änderungen mit Relevanz für Betrieb und Governance.',
            'message_center_section_intro_en' => 'Important upcoming Microsoft 365 changes for operations and governance.',
            'message_center_empty_text' => 'Der Message-Center-Feed ist aktuell nicht verfügbar.',
            'message_center_empty_text_en' => 'The message center feed is currently unavailable.',
